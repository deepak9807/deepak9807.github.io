...
- In the rare cases when we share your personal information in identifiable form with our clients or third party vendors, we will do so only for legitimate business purposes and will seek your express consent before sharing. When we use direct identifiers, we limit disclosure to the extent necessary.
...
- Individuals that are interested in exercising one or more of the rights described above can submit a request using the form here  or contact us at deepakchaube00@gmail.com .
